...
import { HostedListTable } from './HostedListTable/HostedListTable.tsx'
    ...
    <>
      <div style={mainDivStyle}>
        ...
        <div style={tableContainer}>
          <HostedListTable listQueryKey={hostedQueryKey} getAllEntities={hosteds.findAll} deleteEntity={hosteds.deleteHosted}/>
        </div>
      </div>
    </>
  )
